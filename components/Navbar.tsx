        ...
        <nav className={`w-full px-4 fixed top-0 left-0 z-50 transition-all duration-500 ${isTransparent ? 'bg-transparent text-white' : 'bg-white'}`}>
            <div className={`max-w-6xl mx-auto flex items-center justify-between transition-all duration-500 ${isTransparent ? 'py-1 md:py-0 border-b border-white/10' : 'py-1 border-b border-gray-200'}`}>
                ...
                <div className="hidden md:flex items-center space-x-3">
                    <a href="https://www.facebook.com/share/17MZxWnGPE/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className={`${isTransparent ? "flex items-center justify-center " : "flex items-center justify-center"} transition-transform duration-300 hover:-translate-y-2`}><Image src={isTransparent ? '/icons/FacebookWhite.svg' : '/icons/Facebook.svg'} alt="facebook" width={26} height={26} /></a>
                    <a href="https://x.com/najeemfsalaam?s=11" target="_blank" rel="noopener noreferrer" className={`${isTransparent ? "flex items-center justify-center " : "flex items-center justify-center"} transition-transform duration-300 hover:-translate-y-2`}><Image src={isTransparent ? '/icons/XWhite.svg' : '/icons/X.svg'} alt="x" width={26} height={26} /></a>
                    <a href="https://www.instagram.com/najeemsalaam?igsh=MW13bzc5M2kzbWllcQ==" target="_blank" rel="noopener noreferrer" className={`${isTransparent ? "flex items-center justify-center " : "flex items-center justify-center"} transition-transform duration-300 hover:-translate-y-2`}><Image src={isTransparent ? '/icons/InstagramWhite.svg' : '/icons/Instagram.svg'} alt="instagram" width={26} height={26} /></a>
                    <a href="https://wa.me/c/2348150794750" target="_blank" rel="noopener noreferrer" className={`${isTransparent ? "flex items-center justify-center " : "flex items-center justify-center"} transition-transform duration-300 hover:-translate-y-2`}><Image src={isTransparent ? '/icons/WhatsAppWhite.svg' : '/icons/WhatsApp.svg'} alt="whatsapp" width={26} height={26} /></a>
