    ...
    return (
        <div ref={container} className="min-h-screen bg-white overflow-x-hidden">
            ...
            <section className="max-w-7xl mx-auto px-4 py-16 md:py-24 space-y-24">
                ...
                <div ref={educationRef} className="text-center">
                    <div className="flex items-center justify-center gap-2 mb-8">
                        <span className="w-[7px] h-[7px] bg-[#ff8a00]"></span>
                        <h2 className="text-2xl md:text-3xl font-bold font-sans text-gray-900">
                            Early Life and Education
                        </h2>
                    </div>
                    <p className="text-gray-600 font-inter text-sm md:text-base text-left md:text-center mb-16 px-4 md:px-0 font-light">
                ...
                <div ref={serviceRef} className="text-center pt-8">
                    <div className="flex items-center justify-center gap-2 mb-8">
                        <span className="w-[7px] h-[7px] bg-[#ff8a00]"></span>
                        <h2 className="text-2xl md:text-3xl font-bold font-sans text-gray-900">
                            A Defining Era in Public Service
                    ...
                    <div ref={statsContainerRef} className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-x-24 md:gap-y-16 max-w-4xl mx-auto px-4 md:px-0 text-left">
                        {/* Stat 1 */}
                ...
                <div ref={impactRef} className="text-center pt-12 pb-16">
                    <div className="flex items-center justify-center gap-2 mb-8">
