    ...
    return (
        <div className="min-h-screen bg-white">
            <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
                {/* Title */}
                <h1 className="text-5xl md:text-7xl font-sans text-center text-gray-900 mb-20 tracking-wide uppercase">
                    PRIVACY POLICY
                </h1>
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <section>
                        <div className="flex items-center gap-3 mb-6">
                            <span className="w-2.5 h-2.5 bg-[#ff8a00] rounded-sm flex-shrink-0"></span>
