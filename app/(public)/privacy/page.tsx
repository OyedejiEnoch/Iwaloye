                ...
                <div className="max-w-6xl mx-auto space-y-12">
                    ...
                    <section>
                        ...
                        <div className="space-y-6 text-gray-600 text-sm leading-relaxed font-light">
                            ...
                            <p>
                                Ìwàloyè&apos;s campaign does not share or sell collected information without your consent, except when required by law.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-4 text-gray-600 text-sm leading-relaxed font-light">
                            <p>
                                People who subscribe via this website will receive periodic updates from Ìwàloyè by email or text. You may opt out of receiving future communications at any time by following the unsubscribe instructions provided in each message.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-4 text-gray-600 text-sm leading-relaxed font-light">
                            <p>
                                Questions regarding this privacy notice should be emailed to <a href="mailto:info@iwaloye2026.com" className="underline hover:text-gray-900 transition-colors">info@iwaloye2026.com</a>
                            </p>
                        </div>
                    </section>
                </div>
