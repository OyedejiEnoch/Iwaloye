              ...
              <Card className="border-gray-200 shadow-sm overflow-hidden bg-white mb-6">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div
                      className={`relative border-2 border-dashed rounded-xl transition-all duration-200 ${previewUrl ? "border-purple-200 bg-purple-50/30" : "border-gray-200 hover:border-purple-300 bg-gray-50/50"
                        }`}
                    >
                      {previewUrl ? (
